...
public struct FSEventsCreateFlags: OptionSet {
...
/// Flags that can be passed to `FSEvents.init`
...
///
public extension FSEventsCreateFlags {

    /*
     * The default.
     */
    static var none: FSEventsCreateFlags {
        return FSEventsCreateFlags(rawValue: kFSEventStreamCreateFlagNone)
    }
     ...
     */
    internal static var useCFTypes: FSEventsCreateFlags {
        return FSEventsCreateFlags(rawValue: kFSEventStreamCreateFlagUseCFTypes)
    }
     ...
     */
    static var noDefer: FSEventsCreateFlags {
        return FSEventsCreateFlags(rawValue: kFSEventStreamCreateFlagNoDefer)
    }
     ...
     */
    static var watchRoot: FSEventsCreateFlags {
        return FSEventsCreateFlags(rawValue: kFSEventStreamCreateFlagWatchRoot)
    }
    ...
    static var ignoreSelf: FSEventsCreateFlags {
        return FSEventsCreateFlags(rawValue: kFSEventStreamCreateFlagIgnoreSelf)
    }
    ...
    @available(iOS, introduced: 6.0)
    static var fileEvents: FSEventsCreateFlags {
        return FSEventsCreateFlags(rawValue: kFSEventStreamCreateFlagFileEvents)
    }
    ...
    static var markSelf: FSEventsCreateFlags {
        return FSEventsCreateFlags(rawValue: kFSEventStreamCreateFlagMarkSelf)
    }
}
//public enum FSEventsCreateFlags: UInt32, OptionSet {
...
extension FSEventsCreateFlags: Hashable, CustomStringConvertible, CustomDebugStringConvertible {
    public var hashValue: Int {
        return rawValue.hashValue
    }
    private static func getNameMapping() -> [FSEventsCreateFlags: String] {
        return [
            .none: ".none",
    ...
    public var debugDescription: String {
        let map = FSEventsCreateFlags.getNameMapping()
