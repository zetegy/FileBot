...
/// Flags that can be passed to your `FSEvents`'s handler function.
/*
 ...
 */
public struct FSEventsEventFlags: OptionSet {
...
public extension FSEventsEventFlags {

    /*
     * There was some change in the directory at the specific path
     * supplied in this event.
     */
    static var none: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagNone)
    }
     ...
     */
    static var mustScanSubDirs: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagMustScanSubDirs)
    }
     ...
     */
    static var userDropped: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagUserDropped)
    }
     ...
     * present) only provide information to help you diagnose the problem.
     */
    static var kernelDropped: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagKernelDropped)
    }
     ...
     */
    static var idsWrapped: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagEventIdsWrapped)
    }
     ...
     */
    static var historyDone: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagHistoryDone)
    }
     ...
     */
    static var rootChanged: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagRootChanged)
    }
     ...
     */
    static var mount: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagMount)
    }
     ...
     */
    static var unmount: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagUnmount)
    }
     ...
     */
    @available(OSX 10.7, *)
    static var itemCreated: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemCreated)
    }
     ...
     */
    @available(OSX 10.7, *)
    static var itemRemoved: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemRemoved)
    }
     ...
     */
    @available(OSX 10.7, *)
    static var itemInodeMetaMod: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemInodeMetaMod)
    }
     ...
     */
    @available(OSX 10.7, *)
    static var itemRenamed: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemRenamed)
    }
     ...
     */
    @available(OSX 10.7, *)
    static var itemModified: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemModified)
    }
     ...
     */
    @available(OSX 10.7, *)
    static var itemFinderInfoMod: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemFinderInfoMod)
    }
     ...
     */
    @available(OSX 10.7, *)
    static var itemChangeOwner: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemChangeOwner)
    }
     ...
     */
    @available(OSX 10.7, *)
    static var itemXattrMod: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemXattrMod)
    }
     ...
     */
    @available(OSX 10.7, *)
    static var itemIsFile: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemIsFile)
    }
     ...
     */
    @available(OSX 10.7, *)
    static var itemIsDir: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemIsDir)
    }
     ...
     */
    @available(OSX 10.7, *)
    static var itemIsSymlink: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemIsSymlink)
    }
     ...
     */
    @available(OSX 10.9, *)
    static var ownEvent: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagOwnEvent)
    }
     ...
     */
    @available(OSX 10.10, *)
    static var itemIsHardlink: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemIsHardlink)
    }
     ...
     */
    @available(OSX 10.10, *)
    static var itemIsLastHardlink: FSEventsEventFlags {
        return FSEventsEventFlags(rawValue: kFSEventStreamEventFlagItemIsLastHardlink)
    }

}

extension FSEventsEventFlags: Hashable {
    public var hashValue: Int {
        return rawValue.hashValue
    }
}
extension FSEventsEventFlags: CustomStringConvertible, CustomDebugStringConvertible {
//    private static func getAllFlags() -> [FSEventsEventFlags] {
//        return [
////            .none,
//            .mustScanSubDirs,
//            .userDropped,
...
//        ]
//    }
    private static func getNameMapping() -> [FSEventsEventFlags: String] {
        return [
//            .none: ".none",
    ...
    public var debugDescription: String {
        let ns = FSEventsEventFlags.getNameMapping()
