...
public struct FSEventsEventID: Hashable, RawRepresentable {
...
public func == (a: FSEventsEventID, b: FSEventsEventID) -> Bool {
    return a.rawValue == b.rawValue
}

public extension FSEventsEventID {
    static var now: FSEventsEventID {
        return FSEventsEventID(rawValue: kFSEventStreamEventIdSinceNow)
    }
    /*
    ...
    static func getCurrentEventId() -> FSEventsEventID {
        let eventId = FSEventsGetCurrentEventId()
        return FSEventsEventID(rawValue: eventId)
    }
}
